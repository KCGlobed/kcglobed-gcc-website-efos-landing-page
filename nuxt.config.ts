...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    ...
    razorpayAmount: process.env.NUXT_PUBLIC_PAYMENT_AMOUNT || process.env.RAZORPAY_PAYMENT_AMOUNT || '2950',
    ...
    cashfreePaymentAmount: process.env.NUXT_PUBLIC_PAYMENT_AMOUNT || process.env.CASHFREE_PAYMENT_AMOUNT || '2950',
    ...
    public: {
      ...
      paymentAmount: process.env.NUXT_PUBLIC_PAYMENT_AMOUNT || process.env.CASHFREE_PAYMENT_AMOUNT || process.env.RAZORPAY_PAYMENT_AMOUNT || '2950',
      source: process.env.NUXT_PUBLIC_SOURCE || process.env.SOURCE,
