...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    ...
    razorpayAmount: process.env.RAZORPAY_PAYMENT_AMOUNT || process.env.NUXT_PUBLIC_PAYMENT_AMOUNT || '295',
    ...
    cashfreePaymentAmount: process.env.CASHFREE_PAYMENT_AMOUNT || process.env.NUXT_PUBLIC_PAYMENT_AMOUNT || '295',
    ...
    public: {
      ...
      paymentAmount: process.env.RAZORPAY_PAYMENT_AMOUNT || process.env.CASHFREE_PAYMENT_AMOUNT || process.env.NUXT_PUBLIC_PAYMENT_AMOUNT || '295',
      source: process.env.NUXT_PUBLIC_SOURCE || process.env.SOURCE,
