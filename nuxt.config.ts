...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    ...
    public: {
      ...
      jointBrandLogo: process.env.NUXT_PUBLIC_JOINT_BRAND_LOGO || process.env.JOINT_BRAND_LOGO || '',
      brandRedirectionLink: process.env.NUXT_PUBLIC_BRAND_REDIRECTION_LINK || process.env.BRAND_REDIRECTION_LINK || '#',
      jointBrandHomeBanner: process.env.NUXT_PUBLIC_JOINT_BRAND_HOME_BANNER || process.env.HOME_BANNER_FOR_JOINT_COLLAB || ''
