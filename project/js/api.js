...
export const CONFIG = {
    ...
    BACKEND_API_BASE: window.ENV?.BACKEND_API_BASE || 'https://gccwebsite-admin-backend-738131651355.asia-south1.run.app',
    
    // Local server routes (start payment, complete payment, save lead, etc.)
    // Can be set to absolute URL in development (e.g. 'http://localhost:3000') or empty string for relative paths
    LOCAL_API_BASE: window.ENV?.LOCAL_API_BASE || '',
    
    // Source parameter for registration source
    SOURCE: 2 // 2 corresponds to website
};
