<template>
  <div class="thank-you-page">
    ...
    <main class="page">
      <div class="card" role="main" v-aos="'zoom-in'">
        <!-- Left: Icon & Presence -->
        ...
        <div class="right-panel">
          ...
          <div class="help-section">
            ...
            <a href="tel:+919773576111">+91 97735 76111</a>
          </div>

          <!-- <div class="mt-4">
            <NuxtLink to="/" class="btn-home">Return to Home</NuxtLink>
          </div> -->
        </div>
      </div>
    </main>
   ...
   noscript: [
    {
      ...
      tagPosition: 'bodyOpen' // injects right after <body>
    },
    {
      innerHTML: `<img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=1308129784468579&ev=Purchase&cd[value]=2950.00&cd[currency]=INR&noscript=1" />`,
...
.thank-you-page {
  ...
  --card-border: rgba(160, 110, 230, 0.12);
  --accent-purple: #9b7fd4;
  --accent-yellow: #f5b731;
  --text-white: #f0eaf8;
  --text-muted: rgba(210, 195, 240, 0.6);
  --green-dot: #3ecf75;
...
.bg-layer {
  ...
  background-image:
    repeating-linear-gradient(45deg,
      ...
      rgba(130, 80, 210, 0.05) 22px, rgba(130, 80, 210, 0.05) 23px,
...
.check-circle {
  ...
  height: 100%;
  border-radius: 50%;
  border: 2px solid rgba(160, 110, 230, 0.4);
  display: flex;
  align-items: center;
  justify-content: center;
}
...
.vertical-divider {
  width: 1px;
  background: rgba(160, 110, 230, 0.1);
}
...
.ref-box {
  ...
  border: 1px dashed rgba(160, 110, 230, 0.3);
  padding: 12px 20px;
  border-radius: 12px;
  display: inline-flex;
  align-items: center;
...
@media (max-width: 850px) {
  ...
  .left-panel {
    flex: none;
    padding: 40px;
    border-bottom: 1px solid rgba(160, 110, 230, 0.1);
  }
